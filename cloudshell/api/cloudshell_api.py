...
class ConfigParams(CommonAPIRequest):
    def __init__(self, ConfigParam):
        """
            :param ConfigParam ConfigParam: constructor parameter
        """
        CommonAPIRequest.__init__(self, ConfigParam=ConfigParam)

class AppConfiguration(CommonAPIRequest):
    def __init__(self, AppName, ConfigParams):
        """
            :param str AppName: constructor parameter
            :param ConfigParams ConfigParams: constructor parameter
        """
...
class Attributes(CommonAPIRequest):
    def __init__(self, Attribute):
        """
            :param Attribute Attribute: constructor parameter
        """
        CommonAPIRequest.__init__(self, Attribute=Attribute)
...
class AddRestrictionRequest(CommonAPIRequest):
    def __init__(self, FamilyName, ModelName, Alphabetic, Attributes):
        """
            ...
            :param Attributes Attributes: constructor parameter
        """
